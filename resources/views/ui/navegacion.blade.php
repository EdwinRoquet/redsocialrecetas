<a href="{{ route('recetas.create') }}" class="btn btn-outline-primary text-uppercase mt-2 font-weight-bold">
    ...
    Crear Receta</a>
<a href="{{ route('perfiles.edit', ['perfil' => Auth::user()->id]) }}" class="btn btn-outline-success text-uppercase mt-2 font-weight-bold">
    ...
    Editar Perfil</a>
<a href="{{ route('perfiles.show', ['perfil' => Auth::user()->id] ) }}" class="btn btn-outline-info text-uppercase mt-2 font-weight-bold">

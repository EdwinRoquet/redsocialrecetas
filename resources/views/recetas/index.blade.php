        ...
        <tbody>
            ...
            <td>
                <eliminar-receta
                  receta-id={{$receta->id}}
                ></eliminar-receta>
                <a href="{{route('recetas.edit', ['receta' => $receta->id])}}" class="d-block btn btn-dark mb-2">Editar</a>
            <a href="{{route('recetas.show', ['receta' => $receta->id])}}" class=" d-block btn btn-success mb-2">Ver</a>
            </td>
